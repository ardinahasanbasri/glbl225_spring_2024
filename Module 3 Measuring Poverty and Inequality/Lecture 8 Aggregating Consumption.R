<<<<<<< HEAD
#-----------------------------------------------------------------------------
# Code for Lecture 7: Aggregating Expenditure/Consumption using Malawi data 
# 
...
merged_data <- merge(x=food_exp_by_hh, y=hh_info, by.x="case_id", by.y="case_id")
...
>>>>>>> afb2e6d2e3f14670d836ced574fd4125db006566
